...
HD_PWD='C:/Users/zfsalti/488/MP-0/hw/hw.runs/mp0_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mp0_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mp0_auto_pc_1.tcl
